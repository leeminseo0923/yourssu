...
class CommentController (val commentService: CommentService) {
    ...
    fun create(@PathVariable articleId: Long, @RequestBody commentDTO: CommentDTO, @Parameter(hidden = true) @Auth authInfo: AuthInfo): CommentResponse {
    ...
    fun delete(@PathVariable articleId: Long, @PathVariable commentId: Long, @RequestBody registerDTO: RegisterDTO, @Parameter(hidden = true)@Auth authInfo: AuthInfo) {
